...
export const DISTRICT_DATA = {
  cuttack: {
    ...
    policeStations: 30, municipalities: 1, nacs: 2, municipalCorps: 1,
    devScore: 74,
    scores: { governance: 78, education: 80, healthcare: 72, infrastructure: 76, water: 68, economy: 79, safety: 71, agriculture: 60, digital: 73, welfare: 75, environment: 62, connectivity: 71, livelihood: 66, sanitation: 69 },
  ...
  puri: {
    ...
    policeStations: 22, municipalities: 1, nacs: 1, municipalCorps: 0,
    devScore: 71,
    scores: { governance: 72, education: 82, healthcare: 68, infrastructure: 70, water: 65, economy: 74, safety: 69, agriculture: 71, digital: 68, welfare: 72, environment: 67, connectivity: 65, livelihood: 58, sanitation: 74 },
